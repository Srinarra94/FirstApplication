...
namespace FirstApp.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,FatherName,Address,PhoneNumber")] Student student)
        {
            if (ModelState.IsValid)
            {
                ...
                if (existingStudent != null)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "A student with the same name already exists.");
                    return View(student);
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,FatherName,Address,PhoneNumber")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
